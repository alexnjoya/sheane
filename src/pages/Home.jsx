          ...
          <Row>
            <Col lg='6' md='6'>
              <div className='hero_content'>
                ...
                <h2>Make Your Skin the Best it can be with Sheane Cosmetics</h2>
                <p>Lorem ipsum dolor sit, amet consectetur
                  adipisicing elit. Reiciendis voluptatem
                  fugit nesciunt soluta quas deleniti
                  molestiae
                  voluptas nostrum sapiente veritatis.
                </p>
                <motion.button whileTap={{ scale: 1.3 }}
                  className='buy_btn'><Link
          ...
          <Row>
            <Col lg="6" md="12" className="count_down-col">
              <div className="clock_top-content">
                ...
                <h3 className="text-white fs-5 mb-3">Qaulity Armchair</h3>
              </div>
